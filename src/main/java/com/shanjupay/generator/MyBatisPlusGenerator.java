...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setAuthor("Zhou hanlin");
...
//				.setUrl("jdbc:mysql://218.29.75.103:6306/shanjupay_merchant_service?serverTimezone=Asia/Shanghai");
		...
		// 交易服务
		dataSourceConfig
				.setUrl("jdbc:mysql://192.168.1.29:3306/microclass?serverTimezone=Asia/Shanghai");
		// dataSourceConfig.setSchemaName("public");
		dataSourceConfig.setDriverName("com.mysql.cj.jdbc.Driver");
		dataSourceConfig.setUsername("root");
		dataSourceConfig.setPassword("excellen.1");
		autoGenerator.setDataSource(dataSourceConfig);

        // 生成包配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig.setParent("cn.youxinedu");
        //如果需要手动输入模块名
